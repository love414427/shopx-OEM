...
<div class="am-popup common-cropper-popup" id="user-avatar-popup">
    ...
    <div class="user-content">
        <div class="user-content-body">
            <div class="control">
                <button class="am-btn am-btn-primary am-btn-xs am-icon-plus address-submit-save" type="button" data-url="<?php echo MyUrl('index/useraddress/saveinfo'); ?>" data-popup-title="新增地址"> 新增新地址</button>
            </div>
            <?php if(!empty($user_address_list)): ?>
                <ul class="address-list">
                    <?php foreach($user_address_list as $address): ?>
                        <li class="<?php if(isset($address['is_default']) and $address['is_default'] == 1): ?>address-default<?php endif; ?>" id="data-list-<?php echo htmlentities($address['id']); ?>" data-value="<?php echo htmlentities($address['id']); ?>">
