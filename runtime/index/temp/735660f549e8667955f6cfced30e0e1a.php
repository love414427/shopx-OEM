<?php /*a:11:{s:79:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/user/forget_pwd_info.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/header.html";i:1660808542;s:80:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/header_top_nav.html";i:1660808542;s:76:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/nav_search.html";i:1660808542;s:76:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/header_nav.html";i:1660808542;s:80:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/goods_category.html";i:1660808542;s:74:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/not_data.html";i:1660808542;s:77:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/user/images_verify.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/footer.html";i:1660808542;s:76:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/footer_nav.html";i:1663332220;s:71:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/quick.html";i:1660808542;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="am-container user-forgetpwd-container">
		<div class="am-hide-sm-only am-u-md-6 am-u-lg-8 am-vertical-align am-text-center container-left">
			<?php if(!empty($user_forgetpwd_left_data['images'])): ?>
                <a <?php if(empty($user_forgetpwd_left_data['url'])): ?>href="javascript:;"<?php else: ?>href="<?php echo htmlentities($user_forgetpwd_left_data['url']); ?>" target="_blank"<?php endif; ?>>
		...
		<div class="am-u-sm-12 am-u-md-6 am-u-lg-4 container-right">
			...
			<div class="user-form-container">
				<!-- form start -->
				<form class="am-form form-validation am-padding-bottom-sm" method="post" action="<?php echo MyUrl('index/user/forgetpwd'); ?>" request-type="ajax-url" request-value="<?php echo MyUrl('index/user/logininfo'); ?>">
					<div class="am-form-group am-form-group-refreshing business-form-block">
						<label>手机/邮箱</label>
						<input type="text" name="accounts" class="am-radius am-form-field" id="accounts" minlength="1" placeholder="手机/邮箱" data-validation-message="手机/邮箱格式有误" autocomplete="off" required />
					</div>
					...
					<div class="am-form-group am-form-group-refreshing business-form-block am-margin-top-xs">
						...
						<div class="am-input-group am-input-group-sm">
			                ...
			                <span class="am-input-group-btn">
			                    <button class="am-btn am-btn-default am-radius btn-loading-example verify-submit" type="button" data-am-loading="{spinner:'circle-o-notch', loadingText:'发送中...'}" data-url="<?php echo MyUrl('index/user/forgetpwdverifysend'); ?>" data-verify="<?php echo MyC('common_img_verify_state'); ?>" data-text="获取验证码" data-send-text="还有 {time} 秒" data-time="<?php echo MyC('common_verify_interval_time', 30, true); ?>" data-form-tag="form.form-validation">获取验证码</button>
			                </span>
			            </div>
		            </div>
    ...
    <div class="am-modal-dialog am-radius">
        ...
        <div class="am-modal-bd">
            <div class="base">
                ...
                <div class="am-fl">
                    <img src="<?php echo MyUrl('index/user/userverifyentry', ['type'=>'user_forget']); ?>" class="am-radius c-p" id="verify-img" onClick="this.src=this.src+((<?php echo htmlentities($url_model); ?> == 0) ? '&' : '?')+Math.random();" />
                    <a href="javascript:;" class="form-verify-tips" onClick="document.getElementById('verify-img').src='<?php echo MyUrl('index/user/userverifyentry', ['type'=>'user_forget']); if($url_model == 0): ?>&<?php else: ?>?<?php endif; ?>'+Math.random();">更换一张</a>
                </div>
            </div>
