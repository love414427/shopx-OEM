...
<div class="am-popup common-cropper-popup" id="user-avatar-popup">
	...
	<div class="user-content">
		<div class="user-content-body">
			<!-- form start -->
			<form class="am-form form-validation" action="<?php echo MyUrl('index/safety/loginpwdupdate'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('index/safety/index'); ?>">
				<legend>
				...
				<div class="am-form-group">
					<label>当前密码</label>
					<input type="password" name="my_pwd" placeholder="当前密码" pattern="<?php echo MyConst('common_regex_pwd'); ?>" data-validation-message="当前密码格式 6~18 个字符之间" class="am-radius" autocomplete="off" required />
				</div>
				<div class="am-form-group">
					<label>新密码</label>
					<input type="password" name="new_pwd" placeholder="新密码" pattern="<?php echo MyConst('common_regex_pwd'); ?>" data-validation-message="新密码格式 6~18 个字符之间" class="am-radius" id="new-loginpwd" autocomplete="off" required />
				</div>
				<div class="am-form-group">
					<label>确认密码</label>
					<input type="password" name="confirm_new_pwd" placeholder="确认密码" pattern="<?php echo MyConst('common_regex_pwd'); ?>" data-validation-message="确认密码格式 6~18 个字符之间，与新密码一致" class="am-radius" data-equal-to="#new-loginpwd" autocomplete="off" required />
				</div>
