...
<!-- content -->
<div class="am-container cart-content" data-ajax-url="<?php echo MyUrl('index/cart/stock'); ?>">
    <?php if(!empty($cart_list)): ?>
        ...
        <table class="am-table">
            ...
            <tbody>
                <?php foreach($cart_list as $goods): ?>
                    <tr id="data-list-<?php echo htmlentities($goods['id']); ?>" data-id="<?php echo htmlentities($goods['id']); ?>" data-goods-id="<?php echo htmlentities($goods['goods_id']); ?>" class="<?php if($goods['is_error'] == 1): ?>am-danger<?php endif; ?>">
                        <td class="base">
                            <!-- 商品基础前面钩子 开始 -->
                            <?php if(isset($shopxo_is_develop) and $shopxo_is_develop == true): ?>
                                <div class="plugins-tag">
                            ...
                            <label class="am-checkbox-inline am-success am-fl">
                                <input type="checkbox" value="<?php echo htmlentities($goods['id']); ?>" <?php if($goods['is_error'] == 1): ?>disabled<?php endif; ?> data-am-ucheck />
                            </label>
                        ...
                        <td class="number">
                            ...
                            <!-- 数量操作 -->
                            <?php if($goods['is_error'] == 0): ?>
                                <div class="am-input-group am-input-group-sm stock-tag" data-inventory="<?php echo htmlentities($goods['inventory']); ?>" data-price="<?php echo htmlentities($goods['price']); ?>">
                                    <span class="am-input-group-label <?php if($goods['is_shelves'] == 1 and $goods['is_delete_time'] == 0): ?>stock-submit<?php endif; ?>" data-type="min">-</span>
                                    <input type="number" class="am-form-field" value="<?php echo htmlentities($goods['stock']); ?>" <?php if($goods['is_shelves'] != 1 or $goods['is_delete_time'] != 0): ?>disabled<?php endif; ?> data-min-limit="<?php echo htmlentities($goods['buy_min_number']); ?>" data-max-limit="<?php echo htmlentities($goods['buy_max_number']); ?>" data-unit="<?php echo htmlentities($goods['inventory_unit']); ?>" />
                                    <span class="am-input-group-label <?php if($goods['is_shelves'] == 1 and $goods['is_delete_time'] == 0): ?>stock-submit<?php endif; ?>" data-type="add">+</span>
                                </div>
                            <?php else: ?>
                                <p class="invalid-stock"><?php echo htmlentities($goods['stock']); ?></p>
                                <?php if(!empty($goods['error_msg'])): ?>
                                    <p class="am-text-danger am-margin-top-xs tips-error-text"><?php echo htmlentities($goods['error_msg']); ?></p>
                                <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <td class="total-price am-hide-sm-only">
                            ...
                            <strong class="total-price-content"><?php echo htmlentities($currency_symbol); ?><?php echo htmlentities($goods['total_price']); ?></strong>
                        ...
                        <td class="operation">
                            <a href="javascript:;" class="am-text-danger submit-delete" data-url="<?php echo MyUrl('index/cart/delete'); ?>" data-id="<?php echo htmlentities($goods['id']); ?>" data-view="fun" data-value="ViewDeleteBack">删除</a>
        ...
        <div class="cart-nav">
            <div class="am-fl nav-left am-margin-left-xs">
                ...
                <a href="javascript:;" class="am-margin-left-sm nav-delete-submit submit-ajax" data-url="<?php echo MyUrl('index/cart/delete'); ?>" data-id="0" data-view="reload" data-msg="删除后不可恢复、确认操作吗？">删除</a>
            ...
            <div class="am-fr nav-right">
                ...
                <form action="<?php echo MyUrl('index/buy/index'); ?>" method="post" class="am-fr">
                    <span class="selected-tips am-fl"><span>已选商品</span> <strong>0</strong> <span>件</span></span>
                    <span class="total-price-tips am-fl">合计：</span>
                    <strong class="nav-total-price am-fl"><?php echo htmlentities($currency_symbol); ?>0.00</strong>
        ...
        <div class="mixed-tips">
            ...
            <div class="mixed-tips-content am-fl">
                ...
                <ul>
                    <li>
                       <span>看看</span>
                        <a href="<?php if(empty($user)): ?>javascript:;<?php else: ?><?php echo MyUrl('index/usergoodsfavor/index'); ?><?php endif; ?>" class="<?php if(empty($user)): ?>login-event<?php endif; ?>">我的收藏夹</a> 
                    </li>
                    <li>
                       <span>看看</span>
                        <a href="<?php if(empty($user)): ?>javascript:;<?php else: ?><?php echo MyUrl('index/order/index'); ?><?php endif; ?>" class="<?php if(empty($user)): ?>login-event<?php endif; ?>">我的订单</a> 
                    </li>
                </ul>
            </div>
        </div>
