<?php /*a:12:{s:69:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/user/index.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/header.html";i:1660808542;s:69:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/nav.html";i:1660808542;s:80:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/header_top_nav.html";i:1660808542;s:76:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/nav_search.html";i:1660808542;s:76:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/header_nav.html";i:1660808542;s:80:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/goods_category.html";i:1660808542;s:74:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/not_data.html";i:1660808542;s:75:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/user_menu.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/footer.html";i:1660808542;s:76:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/footer_nav.html";i:1663332220;s:71:"/home/wwwroot/chunguimaoyi.com/app/index/view/default/public/quick.html";i:1660808542;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="user-content">
        <div class="user-content-body">
            ...
            <div class="user-base">
                ...
                <?php if(!empty($mini_navigation)): ?>
                    <ul class="user-base-icon">
                        <?php foreach($mini_navigation as $nav): ?>
                            <li>
                                <a href="<?php echo htmlentities($nav['url']); ?>">
                                    <p><?php echo htmlentities($nav['value']); ?></p>
                                    <p><?php echo htmlentities($nav['name']); ?></p>
                                </a>
                            </li>
                        <?php endforeach; ?>
            ...
            <?php endif; if(!empty($plugins_view_user_base_bottom_data) and is_array($plugins_view_user_base_bottom_data)): foreach($plugins_view_user_base_bottom_data as $hook): if(is_string($hook) or is_int($hook)): ?>
                        <?php echo $hook; ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            <?php endif; ?>
            ...
            <?php if(!empty($user_order_status)): ?>
                <ul class="order-base">
                    <?php foreach($user_order_status as $v): if(in_array($v['status'], [1,2,3])): ?>
                            <li>
                                <a href="<?php echo MyUrl('index/order/index', [$form_search_order_status_form_key=>$v['status']]); ?>">
                        ...
                        <?php elseif(in_array($v['status'], [100])): ?>
                            <li>
                                <a href="<?php echo MyUrl('index/order/index', [$form_search_order_status_form_key=>4, $form_search_order_user_is_comments_form_key=>0]); ?>">
                                    <i class="icon-<?php echo htmlentities($v['status']); ?>"></i>
                                    <p><?php echo htmlentities($v['name']); ?></p>
                                    <?php if(!empty($v['count'])): ?>
                                        <span class="am-badge am-badge-danger am-round"><?php echo htmlentities($v['count']); ?></span>
                        ...
                        <?php elseif(in_array($v['status'], [101])): ?>
                            <li>
                                <a href="<?php echo MyUrl('index/orderaftersale/index'); ?>">
                                    <i class="icon-<?php echo htmlentities($v['status']); ?>"></i>
                                    <p><?php echo htmlentities($v['name']); ?></p>
                                    <?php if(!empty($v['count'])): ?>
                                        <span class="am-badge am-badge-danger am-round"><?php echo htmlentities($v['count']); ?></span>
            ...
            <?php endif; if(!empty($plugins_view_user_various_top_data) and is_array($plugins_view_user_various_top_data)): foreach($plugins_view_user_various_top_data as $hook): if(is_string($hook) or is_int($hook)): ?>
                        <?php echo $hook; ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            <?php endif; ?>
            ...
            <div class="am-g various">
                ...
                <?php endif; if(!empty($plugins_view_user_various_inside_top_data) and is_array($plugins_view_user_various_inside_top_data)): foreach($plugins_view_user_various_inside_top_data as $hook): if(is_string($hook) or is_int($hook)): ?>
                            <?php echo $hook; ?>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php endif; ?>
                            ...
                            <?php if(!empty($order_list)): foreach($order_list as $order): foreach($order['items'] as $key=>$goods): if($key == 0): ?>
                                            <div class="goods-detail">
                                                ...
                                                <div class="goods-base">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <span class="line-price"><?php echo htmlentities($order['currency_data']['currency_symbol']); ?><?php echo htmlentities($order['price']); ?></span>
                                                        </li>
                                                        <li>
                                                            ...
                                                            <?php if($order['items_count'] > 1): ?>
                                                                <span class="items-count">
                                                                    <em>等</em>
                                                                    <em><?php echo htmlentities($order['items_count']); ?></em>
                                                                    <em>种商品</em>
                                                                </span>
                                                            <?php endif; ?>
                                                        </li>
                                                ...
                                                <?php if(in_array($order['status'], [1])): ?>
                                                    <a class="am-btn am-btn-primary am-btn-xs am-radius am-fr order-submit" href="<?php echo MyUrl('index/order/detail', ['id'=>$order['id'], 'ids'=>$order['id'], 'is_pay_auto'=>1]); ?>" target="_blank">支付</a>
                            ...
                            <?php if(!empty($cart_list)): foreach($cart_list as $key=>$goods): if($key < 3): ?>
                                        <div class="goods-detail">
                                            ...
                                            <div class="goods-base">
                                                ...
                                                <ul>
                                                    <li>
                                                        <span class="line-price"><?php echo htmlentities($currency_symbol); ?><?php echo htmlentities($goods['price']); ?></span>
                    ...
                    <div class="am-panel am-panel-default">
                        <div class="am-panel-hd">
                            ...
                            <?php if(!empty($goods_favor_list)): ?>
                                <a class="am-fr more-tips" href="<?php echo MyUrl('index/usergoodsfavor/index'); ?>" target="_blank">
                                    更多 <span class="am-icon-angle-double-right"></span>
                                </a>
                            <?php endif; ?>
                        </div>
                                        ...
                                        <li>
                                            <div class="am-gallery-item">
                                                <a href="<?php echo MyUrl('index/goods/index', ['id'=>$goods['goods_id']]); ?>" target="_blank">
                                                    ...
                                                    <div class="am-gallery-desc line-price"><?php echo htmlentities($currency_symbol); ?><?php echo htmlentities($goods['min_price']); ?></div>
                                                </a>
                                            </div>
                                        </li>
                                    <?php endforeach; ?>
                ...
                <?php endif; if(!empty($plugins_view_user_various_inside_bottom_data) and is_array($plugins_view_user_various_inside_bottom_data)): foreach($plugins_view_user_various_inside_bottom_data as $hook): if(is_string($hook) or is_int($hook)): ?>
                            <?php echo $hook; ?>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php endif; ?>
            ...
            <?php endif; if(!empty($plugins_view_user_various_bottom_data) and is_array($plugins_view_user_various_bottom_data)): foreach($plugins_view_user_various_bottom_data as $hook): if(is_string($hook) or is_int($hook)): ?>
                        <?php echo $hook; ?>
                    <?php endif; ?>
                <?php endforeach; ?>
            <?php endif; ?>
