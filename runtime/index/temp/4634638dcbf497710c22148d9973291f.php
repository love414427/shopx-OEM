...
<div class="am-popup common-cropper-popup" id="user-avatar-popup">
    ...
    <div class="am-alert am-alert-secondary" data-am-alert>
        <div class="available">
            <span>正常可用</span>
            <span class="panel-value"><?php echo htmlentities($user_integral_data['integral']); ?></span>
            <em>积分</em>
            <span class="panel-tips">可以正常使用的积分</span>
        </div>
        <div class="locking">
            <span>当前锁定</span>
            <span class="panel-value"><?php echo htmlentities($user_integral_data['locking_integral']); ?></span>
            <em>积分</em>
    ...
    <table class="am-table am-table-striped am-table-hover am-table-bordered am-text-nowrap form-table-data-list">
        ...
        <tbody>
            <?php if(!empty($data_list) and !empty($form_table['base']['key_field'])): ?>
                <!-- 处理数据数量小于默认数量 -->
                <?php $__FOR_START_1810914049__=0;$__FOR_END_1810914049__=count($data_list);for($i=$__FOR_START_1810914049__;$i < $__FOR_END_1810914049__;$i+=1){ ?>
                    <!-- 1. tr 主键id名称 -->
                    <!-- 2. 是否黄色选中class -->
                    <tr
