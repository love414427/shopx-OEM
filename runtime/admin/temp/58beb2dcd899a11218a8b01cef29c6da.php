<?php /*a:7:{s:71:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/goods/detail.html";i:1660808542;s:79:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/module/detail.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/header.html";i:1663335376;s:78:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/page_loading.html";i:1660808542;s:74:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/not_data.html";i:1660808542;s:92:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/goodsparamstemplate/detail.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/footer.html";i:1663334516;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="am-padding-sm">
    ...
    <div class="am-panel am-panel-default">
        ...
        <div class="am-panel-bd">
            <?php if(!empty($data['video'])): ?>
                <video src="<?php echo htmlentities($data['video']); ?>" class="am-img-responsive" controls="controls" preload="auto">
    ...
    <div class="am-panel am-panel-default">
        ...
        <div class="am-panel-bd">
            <?php if(!empty($data['photo']) and is_array($data['photo'])): ?>
                    ...
                    <div data-am-widget="slider" class="am-slider am-slider-default" data-am-slider='{"animation":"slide","animationLoop":false,"itemWidth":200,"itemMargin":5}'>
                        <ul class="am-slides">
                            <?php foreach($data['photo'] as $v): ?>
                                <li>
                                    <a href="<?php echo htmlentities($v['images']); ?>" target="_blank">
                                        <img src="<?php echo htmlentities($v['images']); ?>" height="225" />
                                    </a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
    ...
    <div class="am-panel am-panel-default">
        ...
        <div class="am-panel-bd">
            <?php if(!empty($specifications) and is_array($specifications)): ?>
                <div class="am-scrollable-vertical am-scrollable-horizontal">
                    <table class="am-table am-table-bordered am-table-striped am-text-nowrap">
                        <thead>
                            <tr>
                                <?php foreach($specifications['type'] as $line_k=>$line_v): ?>
                                    <th><?php echo htmlentities($line_v['name']); ?></th>
                                <?php endforeach; ?>
                                <th>销售价(元)</th>
                                <th>原价(元)</th>
                                <th>库存</th>
                        ...
                        <tbody>
                            <?php foreach($specifications['value'] as $line_k=>$line_v): ?>
                                <tr>
                                    <?php foreach($line_v as $v): if(isset($v['data_type'])): switch($v['data_type']): case "spec": ?>
                                                    <td class="am-text-middle"><?php echo htmlentities($v['data']['value']); ?></td>
                                                <?php break; case "base": ?>
                                                    <td class="am-text-middle"><?php if(isset($v['data']['price'])): ?><?php echo htmlentities($v['data']['price']); ?><?php endif; ?></td>
                                                    <td class="am-text-middle"><?php if(isset($v['data']['original_price']) and $v['data']['original_price'] > 0): ?><?php echo htmlentities($v['data']['original_price']); ?><?php endif; ?></td>
                                                    <td class="am-text-middle"><?php if(isset($v['data']['inventory'])): ?><?php echo htmlentities($v['data']['inventory']); ?><?php endif; ?></td>
                                                    <td class="am-text-middle"><?php if(isset($v['data']['weight']) and $v['data']['weight'] 
                                                    > 0): ?><?php echo htmlentities($v['data']['weight']); ?><?php endif; ?></td>
                                                    <td class="am-text-middle"><?php if(isset($v['data']['volume']) and $v['data']['volume'] 
                                                    > 0): ?><?php echo htmlentities($v['data']['volume']); ?><?php endif; ?></td>
                                                    <td class="am-text-middle"><?php if(isset($v['data']['coding'])): ?><?php echo htmlentities($v['data']['coding']); ?><?php endif; ?></td>
                                                    <td class="am-text-middle"><?php if(isset($v['data']['barcode'])): ?><?php echo htmlentities($v['data']['barcode']); ?><?php endif; ?></td>
                                                <?php break; ?>
                                            <?php endswitch; ?>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
            ...
            <?php if(!empty($specifications) and is_array($specifications)): ?>
                <div class="am-scrollable-vertical">
                    <ul data-am-widget="gallery" class="am-gallery am-avg-sm-2 am-avg-md-4 am-avg-lg-6 am-gallery-bordered am-padding-0">
                        <?php foreach($specifications['type'] as $line_k=>$line_v): foreach($line_v['value'] as $v): if(!empty($v['images'])): ?>
                                    <li>
                                        <div class="am-gallery-item">
                                            <a href="<?php echo htmlentities($v['images']); ?>" target="_blank">
                                                <img src="<?php echo htmlentities($v['images']); ?>" alt="<?php echo htmlentities($v['name']); ?>"/>
                                                <h3 class="am-gallery-title am-text-center"><?php echo htmlentities($v['name']); ?></h3>
                                            </a>
                                        </div>
                                    </li>
                                <?php endif; ?>
    ...
    <div class="am-panel am-panel-default">
        ...
        <div class="am-panel-bd">
            <?php if(!empty($parameters) and is_array($parameters)): ?>
    <div class="am-scrollable-vertical am-scrollable-horizontal">
        <table class="am-table am-table-bordered am-table-striped am-text-nowrap">
            <thead>
                <tr>
            ...
            <tbody>
                <?php foreach($parameters as $v): ?>
                    <tr>
                        <td class="am-text-middle"><?php if(isset($common_goods_parameters_type_list[$v['type']])): ?><?php echo htmlentities($common_goods_parameters_type_list[$v['type']]['name']); ?><?php endif; ?></td>
                        <td class="am-text-middle"><?php echo htmlentities($v['name']); ?></td>
                        <td class="am-text-middle"><?php echo htmlentities($v['value']); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
<?php endif; ?>
    ...
    <div class="am-panel am-panel-default">
        ...
        <div class="am-panel-bd">
            <?php if(!empty($data['content_app']) and is_array($data['content_app'])): ?>
                <div class="am-scrollable-vertical am-nowrap-initial am-img-responsive">
                    <ul>
                        <?php foreach($data['content_app'] as $v): ?>
                            <li class="am-margin-bottom-sm">
                                <a href="<?php echo htmlentities($v['images']); ?>" target="_blank">
                                    <img src="<?php echo htmlentities($v['images']); ?>" />
                                </a>
                                <?php if(!empty($v['content']) and is_array($v['content'])): ?>
                                    <div class="am-margin-top-sm">
                                        <?php foreach($v['content'] as $text): ?>
    ...
    <div class="am-panel am-panel-default">
        ...
        <div class="am-panel-bd">
            <?php if(!empty($data['fictitious_goods_value'])): ?>
                <div class="am-scrollable-vertical am-nowrap-initial am-img-responsive">
                    <?php echo $data['fictitious_goods_value']; ?>
                </div>
            <?php else: ?>
                <div class="table-no"><i class="am-icon-warning"></i> 没有相关数据</div>
            <?php endif; ?>
    ...
    <div class="am-panel am-panel-default">
        ...
        <div class="am-panel-bd">
            <?php if(!empty($data)): ?>
                <dl class="dl-content">
                    <dt>SEO标题</dt>
                    <dd><?php echo htmlentities($data['seo_title']); ?></dd>

                    <dt>SEO关键字</dt>
                    <dd><?php echo htmlentities($data['seo_keywords']); ?></dd>

                    <dt>SEO描述</dt>
                    <dd><?php echo htmlentities($data['seo_desc']); ?></dd>
                </dl>
            <?php else: ?>
                <div class="table-no"><i class="am-icon-warning"></i> 没有相关数据</div>
            <?php endif; ?>
