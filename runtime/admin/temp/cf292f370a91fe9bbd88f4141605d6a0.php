<?php /*a:5:{s:79:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/apphomenav/save_info.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/header.html";i:1663335376;s:78:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/page_loading.html";i:1660808542;s:82:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/event_value_tips.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/footer.html";i:1663334516;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation" action="<?php echo MyUrl('admin/apphomenav/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/apphomenav/index', $params); ?>" enctype="multipart/form-data">
			<legend>
				<span class="am-text-default">手机首页导航<?php if(empty($data['id'])): ?>添加<?php else: ?>编辑<?php endif; ?></span>
				<a href="<?php echo MyUrl('admin/apphomenav/index', $params); ?>" class="am-fr am-text-sm am-margin-top-sm am-icon-mail-reply"> 返回</a>
			</legend>
			<div class="am-form-group">
				<label>名称</label>
				<input type="text" name="name" placeholder="名称" minlength="2" maxlength="60" data-validation-message="名称格式 2~60 个字符" class="am-radius" <?php if(!empty($data)): ?> value="<?php echo htmlentities($data['name']); ?>"<?php endif; ?> required />
			</div>
			...
			<div class="am-form-group">
				<label>事件值</label>
				<input type="text" name="event_value" placeholder="事件值" data-validation-message="事件值最多 255 个字符" class="am-radius" <?php if(!empty($data)): ?> value="<?php echo htmlentities($data['event_value']); ?>"<?php endif; ?> />
        ...
        <div class="am-padding-left-lg">
			...
			<div class="am-form-group am-form-file">
				...
				<ul class="plug-file-upload-view slide-images_url-images-view" data-form-name="images_url" data-max-number="1" data-delete="0" data-dialog-type="images">
					<li>
						<input type="text" name="images_url" value="<?php if(!empty($data['images_url'])): ?><?php echo htmlentities($data['images_url']); ?><?php endif; ?>" data-validation-message="请上传图片" required />
			...
			<div class="am-form-group">
				<label>背景色</label>
				<input type="hidden" name="bg_color" value="<?php if(!empty($data)): ?><?php echo htmlentities($data['bg_color']); ?><?php endif; ?>" />
			...
			<div class="am-form-group">
			    ...
			    <input name="is_need_login" value="1" type="checkbox" data-off-text="否" data-on-text="是" data-size="xs" data-on-color="success" data-off-color="default" data-handle-width="50" data-am-switch <?php if(!empty($data) and $data['is_need_login'] == 1): ?> checked="true"<?php endif; ?> />
			</div>
