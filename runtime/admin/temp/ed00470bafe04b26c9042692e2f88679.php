<?php /*a:6:{s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/appmini/index.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/header.html";i:1663335376;s:78:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/page_loading.html";i:1660808542;s:70:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/appmini/nav.html";i:1660808542;s:75:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/appmini/base_nav.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/footer.html";i:1663334516;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endif; ?>
    ...
    <?php if(!empty($base_nav)): foreach($base_nav as $v): ?>
            <li <?php if($view_type == $v['view_type']): ?>class="am-active"<?php endif; ?>>
                <a href="<?php echo MyUrl('admin/appmini/index', ['nav_type'=>$nav_type, 'view_type'=>$v['view_type']]); ?>"><?php echo htmlentities($v['name']); ?></a>
            </li>
        <?php endforeach; ?>
    <?php endif; ?>
    <li class="fr">
        <a class="am-margin-left-sm" href="<?php echo htmlentities($store_theme_url); ?>" target="_blank">更多主题下载 <i class="am-icon-external-link"></i></a>
    </li>
</ul>
        <!-- nav end -->
        ...
        <?php if(!empty($data_list)): ?>
            <ul data-am-widget="gallery" class="am-gallery am-avg-sm-2 am-avg-md-3 am-avg-lg-4 am-gallery-bordered data-list" data-am-gallery="{}" data-select-url="<?php echo MyUrl('admin/appmini/themesave'); ?>" data-nav-type="<?php echo htmlentities($nav_type); ?>">
                            ...
                            <div class="am-gallery-item-bottom am-padding-sm">
                                <h3 class="am-gallery-title am-margin-top-0">
                                    ...
                                    <div class="am-fr am-text-right">
                                        <?php if(!empty($upgrade_info) and isset($upgrade_info[$v['theme']]) and $upgrade_info[$v['theme']]['version_new'] != $v['ver']): ?>
                                            <a href="javascript:;" class="am-icon-refresh am-text-danger package-upgrade-event" title="更新" data-type="minitheme" data-name="<?php echo htmlentities($v['name']); ?>" data-value="<?php echo htmlentities($v['theme']); ?>" data-terminal="<?php echo htmlentities($nav_type); ?>" data-json="<?php echo urlencode(json_encode($upgrade_info[$v['theme']])); ?>"></a>
                                        <?php endif; if(isset($shopxo_is_develop) and $shopxo_is_develop == true): ?>
                                            <a href="<?php echo MyUrl('admin/appmini/themedownload', ['id'=>$v['theme'], 'nav_type'=>$nav_type]); ?>" class="am-icon-trash-o am-icon-download am-margin-left-sm" title="打包"></a>
                                        <?php endif; if($v['is_delete'] == 1): ?>
                                            <a href="javascript:;" class="am-icon-trash-o submit-delete am-margin-left-sm am-text-warning" title="删除" data-url="<?php echo MyUrl('admin/appmini/themedelete', ['nav_type'=>$nav_type]); ?>" data-id="<?php echo htmlentities($v['theme']); ?>"></a>
                                        <?php endif; ?>
                                    </div>
                                </h3>
