<?php /*a:4:{s:76:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/jump_error.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/header.html";i:1663335376;s:78:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/page_loading.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/footer.html";i:1663334516;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
    <div class="content">
        <div class="am-text-center am-margin-top-xl am-padding-xl">
            ...
            <p class="am-margin-top-xs am-text-sm"><?php if(isset($msg)): ?><?php echo htmlentities($msg); else: ?>操作失败<?php endif; ?></p>
            <p class="am-margin-top-xl">
                <a href="javascript:history.go(-1)" class="am-text-primary">返回上一页</a>
                <span class="am-margin-left-sm"><span class="wait-time"><?php if(empty($wait_time)): ?>5<?php else: ?><?php echo htmlentities($wait_time); ?><?php endif; ?></span>秒自动返回</span>
            </p>
        </div>
    </div>
</div>
