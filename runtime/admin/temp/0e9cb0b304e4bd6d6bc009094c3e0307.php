<?php /*a:5:{s:76:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/article/save_info.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/header.html";i:1663335376;s:78:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/page_loading.html";i:1660808542;s:66:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/lib/seo.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/footer.html";i:1663334516;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation" action="<?php echo MyUrl('admin/article/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/article/index', $params); ?>">
			<legend>
				<span class="am-text-default">文章<?php if(empty($data['id'])): ?>添加<?php else: ?>编辑<?php endif; ?></span>
				<a href="<?php echo MyUrl('admin/article/index', $params); ?>" class="am-fr am-text-sm am-margin-top-sm am-icon-mail-reply"> 返回</a>
			</legend>
			<div class="am-form-group">
				...
				<div class="am-input-group am-input-group-sm">
					...
					<input type="text" name="title" placeholder="标题" minlength="2" maxlength="60" data-validation-message="标题长度 2~60 个字符" class="am-form-field am-radius" <?php if(!empty($data)): ?> value="<?php echo htmlentities($data['title']); ?>" <?php endif; if(!empty($data['title_color'])): ?> style="color:<?php echo htmlentities($data['title_color']); ?>;" <?php endif; ?> required />
			...
			<div class="am-form-group">
				...
				<input type="url" name="jump_url" placeholder="跳转url地址" data-validation-message="跳转url地址格式有误" class="am-radius" <?php if(!empty($data)): ?> value="<?php echo htmlentities($data['jump_url']); ?>"<?php endif; ?> />
			</div>
			<div class="am-form-group">
			    <label class="block">是否启用</label>
			    <input name="is_enable" value="1" type="checkbox" data-off-text="否" data-on-text="是" data-size="xs" data-on-color="success" data-off-color="default" data-handle-width="50" data-am-switch <?php if(!empty($data) and $data['is_enable'] == 1): ?>checked="true"<?php endif; ?> />
			</div>
			<div class="am-form-group">
			    <label class="block">首页推荐</label>
			    <input name="is_home_recommended" value="1" type="checkbox" data-off-text="否" data-on-text="是" data-size="xs" data-on-color="success" data-off-color="default" data-handle-width="50" data-am-switch <?php if(!empty($data) and $data['is_home_recommended'] == 1): ?>checked="true"<?php endif; ?> />
			</div>
			<div class="am-form-group">
				<label>内容</label>
				<textarea class="am-radius am-validate" name="content" rows="5" minlength="10" maxlength="105000" <?php if(!IsMobile()): ?>id="editor-tag" data-url="<?php echo MyUrl('admin/ueditor/index', ['path_type'=>'article']); ?>" placeholder="内容格式 10~105000 个字符之间" <?php else: ?> placeholder="内容格式 10~105000 个字符之间更多编辑功能请使用电脑访问" <?php endif; ?> data-validation-message="内容格式 10~105000 个字符之间" required><?php if(!empty($data)): ?><?php echo htmlentities($data['content']); ?><?php endif; ?></textarea>
			</div>
