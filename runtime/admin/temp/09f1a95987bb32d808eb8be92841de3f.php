<?php /*a:4:{s:79:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/packageinstall/index.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/header.html";i:1663335376;s:78:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/page_loading.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/footer.html";i:1663334516;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- content start  -->
<div class="am-padding-sm packageinstall-container" data-url="<?php echo htmlentities($data['url']); ?>" data-type="<?php echo htmlentities($data['type']); ?>" data-id="<?php echo htmlentities($data['id']); ?>" data-terminal="<?php echo htmlentities($data['terminal']); ?>" data-admin-url="<?php echo htmlentities($data['admin_url']); ?>">
    <!-- 进行中  -->
    ...
    <div class="table-no success-container am-text-center am-hide">
        ...
        <a class="am-btn am-btn-secondary am-btn-xs am-radius am-margin-top-lg" href="<?php echo htmlentities($data['admin_url']); ?>">返回后台</a>
    </div>
