<?php /*a:4:{s:88:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/warehousegoods/inventory_info.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/header.html";i:1663335376;s:78:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/page_loading.html";i:1660808542;s:72:"/home/wwwroot/chunguimaoyi.com/app/admin/view/default/public/footer.html";i:1663334516;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
    <div class="content">
        <?php if(!empty($data['spec'])): ?>
            <!-- form start -->
            <form class="am-form form-validation" action="<?php echo MyUrl('admin/warehousegoods/inventorysave'); ?>" method="POST" request-type="ajax-fun" request-value="ViewModalBack">
                <table class="am-table am-table-striped am-table-hover form-inventory-container">
                                    ...
                                    <div class="am-dropdown-content">
                                        <div class="am-input-group am-input-group-sm">
                                            ...
                                            <span class="am-input-group-btn">
                                                <button type="button" class="am-btn am-btn-default inventory-all-submit">确认</button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <tbody>
                        <?php foreach($data['spec'] as $v): ?>
                            <tr>
                                <td><?php echo htmlentities($v['name']); ?></td>
                                <td>
                                    <input type="number" name="specifications_inventory[]" value="<?php if(!empty($v['inventory'])): ?><?php echo htmlentities($v['inventory']); ?><?php endif; ?>" placeholder="库存" class="am-radius" min="0" max="100000000" pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$" data-validation-message="库存数量 0~100000000" />
                                    <input type="hidden" name="specifications_md5_key[]" value="<?php echo htmlentities($v['md5_key']); ?>" />
                                    <input type="hidden" name="specifications_spec[]" value="<?php echo htmlentities($v['spec']); ?>" />
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                ...
                <div class="form-inventory-submit">
                    <input type="hidden" name="id" <?php if(!empty($data['data'])): ?> value="<?php echo htmlentities($data['data']['id']); ?>"<?php endif; ?> />
